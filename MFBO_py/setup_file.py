...
def sample_parameters(spaceSize, parameter_space):
    ...
    parameter_space: dict
        A dictionary where each key represents a parameter and the value is either:
        - A tuple (min, max) for continuous parameters
        - A list of discrete values for categorical parameters
    
    Returns: numpy array of shape (spaceSize, num_params)
    """
    sampled_points = []
